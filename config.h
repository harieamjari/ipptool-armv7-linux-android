...
#define CUPS_DEFAULT_DOMAINSOCKET "/data/data/com.termux/files/usr/var/run/cups/cups.sock"
...
#define CUPS_BINDIR "/data/data/com.termux/files/usr/bin"
#define CUPS_CACHEDIR "/data/data/com.termux/files/usr/var/cache/cups"
#define CUPS_DATADIR "/data/data/com.termux/files/usr/share/cups"
#define CUPS_DOCROOT "/data/data/com.termux/files/usr/share/doc/cups"
#define CUPS_FONTPATH "/data/data/com.termux/files/usr/share/cups/fonts"
#define CUPS_LOCALEDIR "/data/data/com.termux/files/usr/share/locale"
#define CUPS_LOGDIR "/data/data/com.termux/files/usr/var/log/cups"
#define CUPS_REQUESTS "/data/data/com.termux/files/usr/var/spool/cups"
#define CUPS_SBINDIR "/data/data/com.termux/files/usr/bin"
#define CUPS_SERVERBIN "/data/data/com.termux/files/usr/lib/cups"
#define CUPS_SERVERROOT "/data/data/com.termux/files/usr/etc/cups"
#define CUPS_STATEDIR "/data/data/com.termux/files/usr/var/run/cups"
